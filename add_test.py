...
class add_test(unittest.TestCase):
    ...
    def test_add_test(self):
        ...
        self.Init_add_creation(wd, Add(firstname="eyuyh", middlename="jknnijmn", lastname="akjkjkkjkj", nickname="asdad",
        ...
        self.init_add_creation(wd)
        self.logout(wd)

    def logout(self, wd):
        wd.find_element_by_link_text("Logout").click()

    def init_add_creation(self, wd):
        wd.find_element_by_xpath("//div[@id='content']/form/input[21]").click()

    def Init_add_creation(self, wd, add):
        # init add creation
